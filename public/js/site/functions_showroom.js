...
function connectKeyboard(){
  ...
  $.keyboard.keyaction.custom_next = function(base) {

    var theBoard = base.$el.getkeyboard();
    var current = $('.ui-keyboard-input-current');
    var parent = current.parents('.form-group');
    var id = '#';
    ...
    theBoard.altActive = theBoard.shiftActive = false;
    theBoard.showKeySet({ name : "normal" });
    return false;
  };
  $.keyboard.keyaction.custom_prev = function(base) {
